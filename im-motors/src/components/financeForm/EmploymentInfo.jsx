      ...
      <div className="employment-info">
        ...
        <div className="input-field address">
          ...
          {this.props.errors.address.length > 0 && (
            <span className="errorMessage">{this.props.errors.address}</span>
          )}
        </div>
        ...
        <div className=" input-field work-phone">
          ...
          {this.props.errors.workPhone.length > 0 && (
            <span className="errorMessage">{this.props.errors.workPhone}</span>
          )}
        </div>
        ...
        <div className=" input-field frequency">
          ...
          {this.props.errors.frequency.length > 0 && (
            <span className="errorMessage">{this.props.errors.frequency}</span>
          )}
        </div>
        <div className=" input-field occuption">
          ...
          {this.props.errors.occupation.length > 0 && (
            <span className="errorMessage">{this.props.errors.occupation}</span>
          )}
        </div>
        <div className=" input-field supervisor">
          ...
          <input
            ...
            required
          />
          {this.props.errors.supervisor.length > 0 && (
            <span className="errorMessage">{this.props.errors.supervisor}</span>
          )}
        </div>
